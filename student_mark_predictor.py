...
dataset = pd.read_csv(r"D:\Dtaa_Science_projects\student_mark_preditiction\student_info.csv")
...
X=dataset1.drop("student_marks",axis="columns")

y=dataset1.drop("study_hours",axis="columns")
...
#use joblib for creating pipline 
import joblib
joblib.dump(regressor,"Desktop")
